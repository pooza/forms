...
class BSUserAgentTest extends BSTest {
	...
	public function execute () {
		...
		$useragent = BSUserAgent::getInstance(
		...
		$this->assert('getInstance_iPhone', $useragent instanceof BSIPhoneUserAgent);
		...
		$this->assert('getInstance_iPad', $useragent instanceof BSIPadUserAgent);
