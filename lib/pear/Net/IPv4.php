...
class Net_IPv4
{
    ...
    function parseAddress($address)
    {
        ...
        if (strchr($address, "/")) {
             ...
             */
            if (mb_eregi("^([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$", $parts[1], $regs)) {
                // hexadecimal string
    ...
    function calculate()
    {
        ...
        // 2006/3/25 tkoishi@b-shock.co.jp
        // is_a関数をinstanceof演算子に修正。
    ...
    function htoa($addr)
    {
        if (mb_eregi("^([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$",
                    $addr, $regs)) {
