...
'aweb','AWeb',
'bonecho','<a href="http://www.mozilla.org/projects/bonecho/" title="Browser home page">BonEcho (Firefox 2.0 development)</a>',
'bpftp','BPFTP',
'camino','Camino',
...
'lilina','<a href="http://lilina.sourceforge.net" title="Browser home page">lilina (RSS Reader)</a>',
...
'potu_rss\-reader','<a href="http://www.potu.com" title="Potu Rss-Reader home page">Potu (RSS Reader)</a>',
...
'vienna', '<a href="http://www.opencommunity.co.uk/vienna2.php" title="Vienna RSS-Reader">Vienna (RSS Reader)</a>',
