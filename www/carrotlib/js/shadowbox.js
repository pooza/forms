 ...
 * @version $Id: shadowbox.js 2226 2010-07-23 02:00:11Z pooza $
 */
 ...
 * Date: Wed Jul 21 11:27:21 +0900 2010
 */
...
function filterGallery() {
    ...
    for (var i = 0; i < S.gallery.length; ++i) {
        ...
        if (needed) {
            ...
            if (swfobject && !swfobject.hasFlashPlayerVersion(flashVersion)) {
...
function removeEvent(el, type, handler) {
    E.stopObserving(el, type, handler);
}
...
S.flv.prototype = {
    ...
    append: function(body, dims) {
        ...
        var height = dims.innerHeight,
            ...
            swf = "/carrotlib/swf/player.swf",
            version = S.options.flashVersion,
            express = "/carrotlib/swf/expressInstall.swf",
            flashvars = apply({
        ...
        swfobject.embedSWF(swf, this.id, width, height, version, express, flashvars, params);
    },
