...
HostAliases="localhost 127.0.0.1 {$config.server_name_aliases}"
DirData="{$config.awstat_data_dir}"
DirLang="{$config.awstats_dir}/lang"
AllowAccessFromWebToFollowingIPAddresses="{$config.admin_networks}"
...
OnlyUserAgents=""
OnlyFiles=""
NotPageList="css js class gif jpg jpeg png bmp ico swf flv"
