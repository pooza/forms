-- MySQL dump 10.13  Distrib 5.6.34, for FreeBSD11.0 (amd64)
--
...
CREATE TABLE `form` (
  ...
  `pc_form_template` text,
  `pc_confirm_template` text,
  `pc_thanx_template` text,
  `mobile_form_template` text,
  `mobile_confirm_template` text,
  `mobile_thanx_template` text,
...
-- Dump completed on 2017-01-01 18:19:28
